...
public class EnemyImporter {
	...
	private final String romFileLocation = Window.getReader().getConfig().getLocation();
	private String cdDataLocation;

	private final byte[] idHeader = new byte[] { 0x00, 0x20, 0x36, 0x46, 0x00, 0x0a };

	private final short[][] frameHeaders = new short[][] {
	...
	private final short[] frameTable = new short[] { 0x00, 0x20, 0x36, 0x46, 0x00, 0x20, 0x36, 0x46, 0x00, 0x20, 0x6B, 0x42,
	...
	private final short[] attribs = new short[] { 0x00, 0x64, 0x00, 0x3C, 0x00, 0x01, 0x0C, 0x4A, 0x00, 0x19, 0x00, 0x05,
	...
	private final short[][] lengths = new short[][] { { 0x70, 0x7c }, { 0x70, 0x79 }, { 0x75, 0x8f }, { 0x75, 0x8f },
			{ 0x72, 0x85 }, { 0x80, 0x8f }, { 0x86, 0x75 }, { 0x8b, 0x4d }, { 0x8d, 0x39 } };

	private final int[] offsets = new int[] { 0x038154, 0x039c74, 0x03b6ec, 0x03d7e2, 0x03f8d8, 0x041676, 0x043a36, 0x0458d6,
			0x046de4 };
	private byte[] frame;
