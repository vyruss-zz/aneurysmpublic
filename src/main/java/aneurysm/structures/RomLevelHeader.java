...
public class RomLevelHeader {
    // Fields matching the record components
    ...
    // Full constructor matching record syntax
    public RomLevelHeader(short numLines, int lineoffs, short numThings, int thingoffs,
    ...
    // Optional setter methods for mutability
    ...
    // toString method for debugging - output in hex
    @Override
    public String toString() {
        return String.format("LevelHeader{" +
                "numLines=%04x , lineoffs=%08x, numThings=%04x, thingoffs=%08x, numLights=%04x, numDoors=%04x, paloffs=%08x, nodeTimer=%04x, nodeoffs=%08x, minimapXScale=%04x, minimapYScale=%04x, minimapXOffset=%04x, minimapWidth=%04x, minimapHeight=%04x, minimapoffs=%08x, gridoffs=%08x}", numLines, lineoffs, numThings, thingoffs, numLights, numDoors, paloffs, nodeTimer, nodeoffs, minimapXScale, minimapYScale, minimapXOffset, minimapWidth, minimapHeight, minimapoffs, gridoffs);
    }
}